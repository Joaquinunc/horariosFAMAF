...
Bienvenidos, en este repositorio se encuentra el proyecto que pretende mostrar los horarios de cursado de todas las carreras y años que se dictan en la Facultad de Matemática, Astronomía, Física y Computación para un ciclo lectivo determinado (actualmente se pueden consultar datos del 2026 para las carreras de grado y los redictados, y el Ingreso en modalidad intensiva). Todo esto a fin de facilitar al alumnado el conocimiento de adónde debe dirigirse para cursar. 
